...
namespace UnityEngine.UI.Extensions
{
    public class ScrollSnapBase : MonoBehaviour
    {
        ...
        [Tooltip("The currently active page")] internal int _currentPage;
        ...
        {
            get { return m_OnSelectionChangeStartEvent; }
        ...
        {
            get { return m_OnSelectionChangeEndEvent; }
        ...
        internal int
            GetPageforPosition(Vector3 pos)
        {
            return _isVertical
        ...
        {
            return _isVertical
                ? -((pos.y - _scrollStartPosition) / _childSize) ==
                  -(int) Math.Round((pos.y - _scrollStartPosition) / _childSize)
                : -((pos.x - _scrollStartPosition) / _childSize) ==
                  -(int) Math.Round((pos.x - _scrollStartPosition) / _childSize);
        }
